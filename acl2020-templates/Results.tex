...
GRAFT-Net \cite{DBLP:conf/emnlp/SunDZMSC18}                &  62.5 &  26.0      \\
KBQA-GST \cite{DBLP:conf/ijcai/LanW019}          &  67.9 &  \textbf{36.5}      \\
\hline
Our Method-joint\_prob             &     62.3  &   31.4        \\
Our Method-joint\_prob\_multiple\_paths             &  65.1     &     -       \\
Our Method-marginal\_prob\_with\_true\_label             &    \textbf{68.5}    &       34.8     \\
Our Method-marginal\_prob\_without\_true\_label             &   68.3    &      27.6    \\
